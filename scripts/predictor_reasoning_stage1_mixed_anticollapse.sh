...
PYTHONUNBUFFERED=1 PYTHONPATH=src python -m ssl_reasoner.train \
  ...
  --contrastive-weight 0.8 \
  --batch-diversity-weight 1.0 \
  --slot-diversity-weight 0.15 \
  --eval-every 250 \
  --sample-count 5 \
  --output-dir checkpoints/predictor_reasoning_stage1_mixed_anticollapse
