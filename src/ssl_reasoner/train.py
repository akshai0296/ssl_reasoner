            ...
            if step == 1 or step % eval_every == 0 or step == steps:
                ...
                metrics = " ".join(
                    ...
                    or key in {
                        ...
                        "latent_reasoning_slot_lhs_acc",
                        "latent_reasoning_slot_rhs_acc",
                        "latent_reasoning_slot_op_acc",
                        ...
                        "latent_reasoning_slot_digit_result_acc",
                        "latent_reasoning_slot_digit_final_acc",
                        "latent_reasoning_slot_digit_carry_acc",
